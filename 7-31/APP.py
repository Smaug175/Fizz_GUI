...
class App:
    ...
    def __init__(self, root):
        ...
        w1_cb['value']=(10,50,30)
        w1_cb.current(1)#设置默认值
    ...
    def begin_game(self):
        ...
        self.game_canvas.create_line(0,screen_height/2,screen_width,screen_height/2,fill='red',width=20)
